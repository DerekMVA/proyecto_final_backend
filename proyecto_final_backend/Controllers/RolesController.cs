...
namespace proyecto_final_backend.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public RolesController(proyecto_final_backendContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Rol.Where(r => !r.Deleted).ToListAsync();
        }
        ...
        public async Task<IActionResult> PutRol(int id, Rol rol)
        {
            ...
            var existing = await _context.Rol.AsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
            if (existing == null || existing.Deleted)
            {
                return NotFound();
            }

            rol.Deleted = existing.Deleted;
